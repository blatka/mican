...
export const SPONSORSHIP_TIERS = {
  ...
  8982: { label: 'Grassroots Guardian', order: 3, weight: 3, color: '#398032', detailPage: false },
  8981: { label: 'Planet Protector',    order: 4, weight: 2, color: '#398032', detailPage: false },
  8980: { label: 'Community Pillar',    order: 5, weight: 1, color: '#398032', detailPage: false },
